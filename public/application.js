...
/***/ (function(module, exports, __webpack_require__) {
	...
	var entryEvents = __webpack_require__(13);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	// the code below is same as training exercise
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var entryApi = __webpack_require__(14);
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  api.signIn(data).then(entryApi.onShowEntries).done(ui.signInSuccess).fail(ui.signInFailure);
	};
...
/***/ (function(module, exports) {
	...
	'use strict';
	// this is identical to what we had going for the auth
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var signInSuccess = function signInSuccess(data) {
	  ...
	  api.showEntries(data).then(ui.showEntriesSuccess).catch(ui.showEntriesFailure);
	};
...
/***/ (function(module, exports) {
	...
	// this was in the handlebars solution
	'use strict';

	var app = {
	  host: 'https://hnd-api.herokuapp.com'
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onShowEntries = function onShowEntries(event) {
	  ...
	  api.showEntries().then(ui.showEntriesSuccess).catch(ui.showEntriesFailure);
	};
	...
	var onAddEntry = function onAddEntry(event) {
	  ...
	  var data = getFormFields(event.target);
	  // console.log('data is ', data)
	  api.addEntry(data).done(ui.addEntrySuccess).fail(ui.addEntryFailure);
	};
	...
	var onUpdateEntry = function onUpdateEntry(event) {
	  ...
	  api.updateEntry(data).done(ui.updateEntrySuccess).fail(ui.updateEntryFailure);
	};
	...
	var onDeleteEntry = function onDeleteEntry(event) {
	  ...
	  // console.log('event is ', event)
	  // console.log('data being sent to api is ', data)
	  api.deleteEntry(data).done(ui.deleteEntrySuccess).fail(ui.deleteEntryFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showEntriesTemplate = __webpack_require__(16);
	var addEntryTemplate = __webpack_require__(16);
	var updateEntryTemplate = __webpack_require__(16);
	var deleteEntryTemplate = __webpack_require__(16);
	var store = __webpack_require__(10);
	...
	var showEntriesFailure = function showEntriesFailure(error) {
	...
	var addEntrySuccess = function addEntrySuccess(data) {
	  ...
	  var addEntryHtml = addEntryTemplate({ entries: data.entries });
	  ...
	  api.showEntries(data).then(showEntriesSuccess).then($('#addEntryFailure').html(' ')).catch(showEntriesFailure);
	};

	var addEntryFailure = function addEntryFailure(error) {
	...
	var updateEntrySuccess = function updateEntrySuccess(data) {
	  ...
	  api.showEntries(data).then(showEntriesSuccess).then($('#updateEntryFailure').html(' ')).catch(showEntriesFailure);
	};

	var updateEntryFailure = function updateEntryFailure(error) {
	...
	var deleteEntrySuccess = function deleteEntrySuccess(data) {
	  ...
	  // console.log('data is ', data)
	  $('#delete').html(' ');
	  api.showEntries(data).then(showEntriesSuccess).then($('#deleteEntryFailure').html(' ')).catch(showEntriesFailure);
	};

	var deleteEntryFailure = function deleteEntryFailure(error) {
	...
	module.exports = {
	  ...
	  showEntriesFailure: showEntriesFailure,
	  addEntrySuccess: addEntrySuccess,
	  addEntryFailure: addEntryFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<!-- goal: each entry's information is displayed within an ul with a data-id attribute. -->\n\n <!-- Developers, why are we using data-id and not just id? -->\n  <ul id=\"delete\"><h2><data-id=\""
	    ...
	    + "</h1>\n      <li>Backstory: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.backstory : stack1), depth0))
	    + "\n      <li>Stopper: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.stopper : stack1), depth0))
	    + "\n      <li>Status: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.status : stack1), depth0))
	    + "\n      <li>ID No.: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\n      <!-- <li>Date Added: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date_added : stack1), depth0))
	    + "\n      <li>Last-Updated: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.updated_at : stack1), depth0))
	    + " -->\n      <!-- <li>Hide (Deleted_flag) "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.deleted_flag : stack1), depth0))
	    + " -->\n  </ul>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.entries : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "afa0884dbb5d1cd1cb341d06ff45597e.jpg";
